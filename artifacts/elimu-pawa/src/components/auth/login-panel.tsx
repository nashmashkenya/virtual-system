  ...
  const formSection = (
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 border-t border-[var(--border)] pt-5 text-xs font-medium">
        <Link href="/register" className="text-[var(--primary)] transition hover:underline">
          Create account
        </Link>
        <span className="hidden text-[var(--subtext)] sm:inline">·</span>
        <Link href="/forgot-password" className="text-[var(--subtext)] transition hover:text-[var(--text)]">
          Forgot password?
        </Link>
      </div>
    </div>
  ...
  if (embedded) {
    return (
      <div className={`${glassShell} p-6 sm:p-8`}>
        <div className="pointer-events-none absolute -right-20 -top-20 h-40 w-40 rounded-full bg-[var(--primary)]/20 blur-3xl dark:bg-blue-500/30" aria-hidden />
        <div className="pointer-events-none absolute -bottom-16 -left-16 h-36 w-36 rounded-full bg-[var(--accent)]/15 blur-3xl dark:bg-violet-500/20" aria-hidden />
    ...
    <div className={`${glassShell} mx-auto w-full max-w-5xl p-6 sm:p-10`}>
      <div className="grid gap-10 lg:grid-cols-[1fr_1.05fr] lg:gap-12">
        <div className="relative space-y-6 lg:pr-4">
          <div className="pointer-events-none absolute -left-8 top-0 h-32 w-32 rounded-full bg-[var(--primary)]/15 blur-2xl dark:bg-blue-500/25" aria-hidden />
          <div className="relative">
        ...
        <div className="relative">
          <div className="pointer-events-none absolute -bottom-8 -right-8 h-36 w-36 rounded-full bg-[var(--accent)]/20 blur-3xl dark:bg-violet-500/25" aria-hidden />
